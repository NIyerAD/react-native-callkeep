...
public class RNCallKeepModule extends ReactContextBaseJavaModule {
	...
	public void startCall(String uuid, String number, String callerName) {
		...
		Log.d(TAG, "startCall number: " + number + ", callerName: " + callerName + " uuid: " + uuid);
	...
	public void endCall(String uuid) {
		Log.d(TAG, "endCall called with uuid: " + uuid);
	...
	public void backToForeground() {
		...
		Log.d(TAG, "backToForeground, app opened: " + (isOpened ? "true" : "false"));
		...
		public void onReceive(Context context, Intent intent) {
			...
			switch (intent.getAction()) {
				...
				case ACTION_ANSWER_CALL:
					// ADD CALLER_NAME AND CALLER_NUMBER TO ARGS
