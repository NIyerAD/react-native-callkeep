...
class RNCallKeep {
  ...
  _setupAndroid = async (options) => {
    ...
    if (options.allowSelfManaged) {
      return;
    }

    const showAccountAlert = await RNCallKeepModule.checkPhoneAccountPermission(options.additionalPermissions || []) && !options.allowSelfManaged;
